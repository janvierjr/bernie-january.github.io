...
4. For safety purposes, let's create a copy of our array. Using the spread operator, assign a copy of our `filterSpecies` array to our `dogContestants` variable.
