...
/*factorial(4)
return 4 * 3 * 2 * 1
// FALSE // return 4 * factorial(3)
// FALSE // return 4 * 3 * factorial(2)
// FALSE // return 4 * 3 * 2 * factorial(1)
// TRUE // return 4 * 3 * 2 * 1
*/
...
var capitalizeFirst = function(array, output = []) {
  ...
  // recursion
  output.push(array[0].charAt(0).toUpperCase().concat(array[0].slice(1)));
  return capitalizeFirst(array.slice(1), output);
};

/**
 * input: array of strings
 * output: array of strings .charAt(0).toUpperCase()
 */
...
/**
 * input: string
 * output" object with first letter of string as key and index as value
 */
...
var alternateSign = function(array, output = []) {
  ...
  if (array[0] === Math.abs(array[0])) {
    output.push(array[0]);
    output.push(Math.abs(array[1]) * -1);
